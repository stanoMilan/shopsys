...
class AggregationResultToProductFilterCountDataTransformer
{
     ...
     */
    public function translateNonPlusNumbers(array $aggregationResult): ProductFilterCountData
    {
     ...
     * @return \Shopsys\FrameworkBundle\Model\Product\Filter\ProductFilterCountData
     */
    public function translateNonPlusNumbersWithParameters(array $aggregationResult): ProductFilterCountData
    {
        $countData = $this->translateNonPlusNumbers($aggregationResult);
